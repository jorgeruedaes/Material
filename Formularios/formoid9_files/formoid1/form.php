...
<form enctype="multipart/form-data" class="formoid-flat-black" style="background-color:#FFFFFF;font-size:14px;font-family:'Lato', sans-serif;color:#666666;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Nuevo Jugador</h2></div>
	...
	<div class="element-input<?php frmd_add_class("input4"); ?>"><label class="title">Equipo:</label><input class="large" type="text" name="input4" /></div>
