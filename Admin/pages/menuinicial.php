...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="../web/images/<?php echo String_Get_Valores('favicon');?>" type="image/x-icon">
...
<body class="theme-blue">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="../web/images/<?php echo String_Get_Valores('favicon');?>" width="48" height="48" alt="User" />
                </div>
